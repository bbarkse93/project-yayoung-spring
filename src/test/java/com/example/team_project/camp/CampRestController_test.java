...
public class CampRestController_test extends MyWithRestDoc {
        ...
        public void getAllCamps_test() throws Exception {
                ...
                resultActions
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[0].campAddress")
                                                .value("강원도 춘천시 남면 가옹개길 52-9"))
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[0].campCallNumber")
                                                .value("1522-1861"))
                                .andExpect(
                                                MockMvcResultMatchers.jsonPath("$.response[0].campWebsite")
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[0].campFieldImage")
                                                .value("camp_map/camp1.png"))
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[1].campAddress")
                                                .value("경북 김천시 어모면 은림로 62-11"))
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[1].campCallNumber")
                                                .value("054-434-6677"))
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[1].campFieldImage")
                                                .value("camp_map/camp2.png"))
                                ...
                                .andExpect(
                                                MockMvcResultMatchers.jsonPath("$.response[2].campAddress")
                                                                .value("강원 횡성군 서원면 서원서로102번길 3-18"))
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[2].campCallNumber")
                                                .value("033-345-3336"))
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[2].campFieldImage")
                                                .value("camp_map/camp3.png"))
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[3].campAddress")
                                                .value("경기 가평군 설악면 유명산길 61-75"))
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[3].campCallNumber")
                                                .value("010-3148-9970"))
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[3].campWebsite")
                                                .value("http://healingpia.co.kr"))
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[3].campFieldImage")
                                                .value("camp_map/camp4.png"))
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[4].campAddress")
                                                .value("충남 태안군 소원면 산간이길 158-24"))
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[4].campCallNumber")
                                                .value("043-1668-3972"))
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[4].campFieldImage")
                                                .value("camp_map/camp5.png"))

                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[5].id").value(6))
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[5].campName")
                                                .value("청주 옥화포시즌캠핑장"))
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[5].campAddress")
                                                .value("강원 평창군 평창읍 뇌운계곡로 659-6"))
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[5].campCallNumber")
                                                .value("033-332-0009"))
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[5].campFieldImage")
                                                .value("camp_map/camp6.png"))
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[6].campAddress")
                                                .value("충북 충주시 앙성면 학교말2길 50"))
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[6].campCallNumber")
                                                .value("033-332-0009"))
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[6].campFieldImage")
                                                .value("camp_map/camp7.png"))
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[7].campAddress")
                                                .value("충남 태안군 남면 몽산포길 63-23"))
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[7].campCallNumber")
                                                .value("033-332-0009"))
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[7].campFieldImage")
                                                .value("camp_map/camp8.png"))
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[8].campAddress")
                                                .value("경북 포항시 북구 죽장면 새마을로 3351"))
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[8].campCallNumber")
                                                .value("033-332-0119"))
                                .andExpect(
                                                MockMvcResultMatchers.jsonPath("$.response[8].campWebsite")
                                                                .value("http://www.gaoncamp.com/"))
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[8].campFieldImage")
                                                .value("camp_map/camp9.png"))
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[9].campAddress")
                                                .value("충북 충주시 앙성면 남한강변길 218-2"))
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[9].campCallNumber")
                                                .value("033-332-0229"))
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[9].campFieldImage")
                                                .value("camp_map/camp10.png"))
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[10].campAddress")
                                                .value("전남 강진군 강진읍 해강로 1038-30"))
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[10].campCallNumber")
                                                .value("033-332-0229"))
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[10].campFieldImage")
                                                .value("camp_map/camp11.png"))
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[11].campAddress")
                                                .value("전북 순창군 팔덕면 산동신흥길 6"))
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[11].campCallNumber")
                                                .value("031-581-9977"))
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[11].campWebsite")
                                                .value("Www.toycamp.kr"))
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[11].campFieldImage")
                                                .value("camp_map/camp12.png"))
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[12].campAddress")
                                                .value("경기 가평군 가평읍 호반로 1700"))
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[12].campCallNumber")
                                                .value("031-581-9977"))
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[12].campWebsite")
                                                .value("Www.toycamp.kr"))
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[12].campFieldImage")
                                                .value("camp_map/camp13.png"))
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[13].campAddress")
                                                .value("충남 부여군 세도면 대흥로 163"))
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[13].campCallNumber")
                                                .value("031-581-9917"))
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[13].campWebsite")
                                                .value("Www.toycamp.kr"))
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[13].campFieldImage")
                                                .value("camp_map/camp14.png"))
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[14].campAddress")
                                                .value("경상북도 영덕군 병곡면 병곡리 58-5"))
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[14].campCallNumber")
                                                .value("031-557-7757"))
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[14].campWebsite")
                                                .value("Www.toycamp.kr"))
                                ...
                                .andExpect(MockMvcResultMatchers.jsonPath("$.response[14].campFieldImage")
                                                .value("camp_map/camp15.png"))
